...
export default function ReportsPage() {
  ...
  return (
    <MainLayout>
      {/* Top Main Intelligence Sticky Panel */}
      ...
      <main className="flex-1 overflow-auto p-4 md:p-10 space-y-6 pb-24 md:pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs flex items-center gap-4">
            <span className="text-3xl bg-green-50 p-4 rounded-2xl">₱</span>
            <div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs flex items-center gap-4">
            <span className="text-3xl bg-blue-50 p-4 rounded-2xl">📋</span>
            <div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs flex items-center gap-4">
            <span className="text-3xl bg-purple-50 p-4 rounded-2xl">📊</span>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-5 md:p-6 rounded-3xl border border-gray-100 shadow-xs lg:col-span-2 flex flex-col">
            ...
            {/* Tailwind Canonical Opt: Swapped out arbitrary pixels for native min-h-70 */}
            <div className="w-full flex-1 min-h-70">
              {isLoading ? (
                ...
                /* FIX: Changed h="..." attribute to complete native height="..." definition */
          ...
          {/* Fulfillment Stream Distribution Breakdown Card */}
              ...
              {isLoading ? (
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={data?.order_distribution} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    {/* FIX: Corrected the typo attribute 'fontWith' to standard strict 'fontWeight' property */}
        ...
        {/* Top Performing Best Selling Dishes Product Ranks Block */}
